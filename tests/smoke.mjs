...
const sw=await fs.readFile('public/sw.js','utf8');assert.ok(sw.includes('bc19-commercial-live-v1'));assert.ok(sw.includes("url.pathname.startsWith('/api/')"));assert.ok(sw.includes('notificationclick'));
