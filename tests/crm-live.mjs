...
for(const marker of ['CRM_DB_NOT_CONFIGURED','organization_id','execute-','crm:lead-create','crm:lead-update','crm:lead-status'])assert.ok(api.includes(marker),`CRM API marker missing: ${marker}`);
