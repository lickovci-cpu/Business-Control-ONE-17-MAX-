...
for(const marker of ['CRM_DB_NOT_CONFIGURED','organization_id','execute-','function taskAction','crm:lead-${a}'])assert.ok(api.includes(marker),`CRM API marker missing: ${marker}`);
